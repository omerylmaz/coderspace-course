...
internal class DeleteOrderByIdCommandHandler(ICourseRepository courseRepository, IUnitOfWork unitOfWork/*, ICacheService cacheService*/) : IRequestHandler<DeleteOrderByIdCommand, Result>
{
